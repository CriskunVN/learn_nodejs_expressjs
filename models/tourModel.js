...
const tourSchema = new mongoose.Schema(
  {
    ...
    ratingsAverage: {
      ...
      set: (val) => Math.round(val * 10) / 10, // this will round the value to 1 decimal place
    },
    // number of ratings
    ratingsQuantity: {
      type: Number,
    ...
    guides: [
      {
        ...
        ref: 'User', // this will make sure that the guides are referenced from the User model
      },
    ],
  },
